...
void ImGui::ShowUserGuide()
{
	...
	ImGui::BulletText("gui specs and about the resolution scale");
    ImGui::Unindent();
}
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (show_app_about)
    {
        ImGui::Begin("About vrDROP", &show_app_about, ImGuiWindowFlags_AlwaysAutoResize);
        ImGui::Text("vrDROP, %s", VRDROP_VERSION);
        ImGui::Separator();
        ImGui::Text("By Tyler Small.");
        ImGui::Text("vrDROP is licensed under the MIT License, see LICENSE for more information.");
        ImGui::End();
    }
    ...
    if (!ImGui::Begin("vrDROP Editor", p_open, window_flags))
    {
    ...
    ImGui::Text("Version: (%s)", VRDROP_VERSION);
    ...
    {
        ImGui::TextWrapped("insert my website here for extra help");
